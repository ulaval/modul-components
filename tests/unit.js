...
var testsContext = crequire.context("../src", true, /(icon|spinner|button|checkbox|date-fields|i18n|icon-button|link|list-item|message|panel|radio|radio-group|validation-message)\.spec$/);
