        ...
        if (value) {
            if (this.popper === undefined) {
                let options: object = {
                    ...
                    modifiers: {
                        preventOverflow: { enabled: this.preventOverflow }, // Modifier used to prevent the popper from being positioned outside the boundary.
                        hide: { enabled: this.preventOverflow } // Requires the preventOverflow modifier before it in order to work.
                    }
                };
