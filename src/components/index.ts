...
import TableBodyPlugin from './table/table-body/table-body';
import TableCellPlugin from './table/table-cell/table-cell';
import TableEmptyPlugin from './table/table-empty/table-empty';
import TableFooterPlugin from './table/table-footer/table-footer';
import TableHeaderPlugin from './table/table-header/table-header';
import TableHeaderCellPlugin from './table/table-header/table-header-cell/table-header-cell';
import TableRowPlugin from './table/table-row/table-row';
...
const ComponentsPlugin: PluginObject<any> = {
    install(v, options: ComponentPluginOptions = {}): void {
        ...
        Vue.use(TableCellPlugin);
        Vue.use(TableBodyPlugin);
        Vue.use(TableFooterPlugin);
        Vue.use(TableEmptyPlugin);
        Vue.use(TableHeaderPlugin);
        Vue.use(TableRowPlugin);
        Vue.use(TabsPlugin);
