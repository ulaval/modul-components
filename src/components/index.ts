...
import MenuItemAddPlugin from './menu-item-add/menu-item-add';
import MenuItemArchivePlugin from './menu-item-archive/menu-item-archive';
import MenuItemDeletePlugin from './menu-item-delete/menu-item-delete';
import MenuItemEditPlugin from './menu-item-edit/menu-item-edit';
...
const ComponentsPlugin: PluginObject<any> = {
    install(v, options): void {
        ...
        Vue.use(MenuItemAddPlugin);
        Vue.use(MenuItemArchivePlugin);
        Vue.use(MenuItemDeletePlugin);
        Vue.use(MenuItemEditPlugin);
