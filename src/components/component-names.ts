...
export const TABLE_CELL_NAME: string = 'm-table-cell';
export const TABLE_BODY_NAME: string = 'm-table-body';
export const TABLE_FOOTER_NAME: string = 'm-table-footer';
export const TABLE_EMPTY_NAME: string = 'm-table-empty';
export const TABLE_HEADER_NAME: string = 'm-table-header';
export const TABLE_ROW_NAME: string = 'm-table-row';
