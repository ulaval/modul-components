...
export const MENU_ITEM_ADD_NAME: string = 'm-menu-item-add';
export const MENU_ITEM_ARCHIVE_NAME: string = 'm-menu-item-archive';
export const MENU_ITEM_DELETE_NAME: string = 'm-menu-item-delete';
export const MENU_ITEM_EDIT_NAME: string = 'm-menu-item-edit';
...
export const RICH_TEXT_EDIT_NAME: string = 'm-rich-text-edit';
