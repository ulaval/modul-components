...
import PageMessagePlugin, { Link, MPageMessage } from './page-message';

let wrapper: Wrapper<MPageMessage>;
...
describe(`page-message fonctionnality tests`, () => {
