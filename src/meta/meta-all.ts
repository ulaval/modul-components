...
import {
    ACCORDION_NAME, ACCORDION_GROUP_NAME, BUTTON_NAME, CHECKBOX_NAME, DIALOG_NAME, DROPDOWN_NAME, DYNAMIC_TEMPLATE_NAME, I18N_NAME, ICON_NAME, INPUT_NAME, LINK_NAME,
    LIST_BULLET_NAME, MESSAGE_NAME, PANEL_NAME, POPPER_NAME, STATUS_LIST_NAME, STEP_NAME, TABLE_NAME, TEXT_ICON_NAME, UPLOAD_NAME
...
export class MetaAll implements PluginObject<any> {
    public install(v, options) {
        ...
        (options as Meta).mergeComponentMeta('fr', INPUT_NAME, require('../components/input/input.meta.json'));
