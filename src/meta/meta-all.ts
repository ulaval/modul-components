...
export class MetaAll implements PluginObject<any> {
    public install(v, options) {
        ...
        meta.mergeComponentMeta(RADIO_STYLE_NAME, require('../components/radio-style/radio-style.meta.json'), CATEGORY_FORMS);
